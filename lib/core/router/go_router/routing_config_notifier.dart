...
import 'package:vvvpn_client/core/router/adaptive_layout/my_adaptive_layout.dart';
...
import 'package:vvvpn_client/features/per_app_proxy/overview/per_app_proxy_page.dart';
import 'package:vvvpn_client/features/profile/details/profile_details_page.dart';
import 'package:vvvpn_client/features/profile/notifier/active_profile_notifier.dart';
import 'package:vvvpn_client/features/profile/overview/profiles_page.dart';
import 'package:vvvpn_client/features/proxy/overview/proxies_overview_page.dart';
import 'package:vvvpn_client/features/settings/overview/sections/dns_options_page.dart';
import 'package:vvvpn_client/features/settings/overview/sections/general_page.dart';
import 'package:vvvpn_client/features/settings/overview/sections/inbound_options_page.dart';
import 'package:vvvpn_client/features/settings/overview/sections/route_options_page.dart';
import 'package:vvvpn_client/features/settings/overview/sections/tls_tricks_page.dart';
import 'package:vvvpn_client/features/settings/overview/sections/warp_options_page.dart';
import 'package:vvvpn_client/features/settings/overview/settings_page.dart';
...
class RoutingConfigNotifier extends _$RoutingConfigNotifier {
  ...
  RoutingConfig build() {
    ...
    if (isMobileBreakpoint == true) {
      ...
      // VVVPN: Pre-MVP 砍 Profiles 多选入口，单订阅由 Home → Add 处理
      showProfilesAction = false;
    }
